...
The source code available on [GitHub](https://github.com/2dengine/sstrict.lua) and the official documentation is on [2dengine.com](https://2dengine.com/doc/sstrict.html)
